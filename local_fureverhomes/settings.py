"""
Django settings for local_fureverhomes project.
...
SECRET_KEY = 'django-insecure-7hykhopkogbx)p%=#y98$w^x9eoq^8l3u*kj6cgmqzrb80ib*w'
...
ROOT_URLCONF = 'local_fureverhomes.urls'
...
WSGI_APPLICATION = 'local_fureverhomes.wsgi.application'
