...
urlpatterns = [
    ...
    path('update_interest_status/<int:pet_profile_id>', views.update_interest_status, name='update_interest_status'),
    #path('mark_as_adopted/<int:pet_profile_id>', views.mark_as_adopted, name='mark_as_adopted'),
    path('update_adoption_status/<int:pet_profile_id>', views.update_adoption_status, name='update_adoption_status'),
    path('fo_liked_pets/', views.fo_liked_pets, name='fo_liked_pets'),
    path('inbox/', views.inbox, name='inbox'),
    path('direct_message/<int:recipient_id>', views.direct_message, name='direct_message'),
